...
struct scaled_dot_product_attention_v1 : public primitive_base<scaled_dot_product_attention_v1> {
    CLDNN_DECLARE_PRIMITIVE(scaled_dot_product_attention_v1)

    scaled_dot_product_attention_v1() : primitive_base("", {}) {}

    /// @brief Constructs scaled_dot_product_attention_v1 primitive.
    ...
    scaled_dot_product_attention_v1(const primitive_id& id,
    ...
    bool operator==(const primitive& rhs) const override {
        ...
        auto rhs_casted = downcast<const scaled_dot_product_attention_v1>(rhs);
    ...
    void save(BinaryOutputBuffer& ob) const override {
        primitive_base<scaled_dot_product_attention_v1>::save(ob);
        ob << is_causal;
    ...
    void load(BinaryInputBuffer& ib) override {
        primitive_base<scaled_dot_product_attention_v1>::load(ib);
        ib >> is_causal;
